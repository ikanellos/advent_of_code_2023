...
# We will build a dictionary of lines.
# Keys are line indexes. Each line will
# store index ranges of numbers and symbols,
# along with their indexes. 
# Each time symbols are found, we check against
# the previous line to see if they are adjacent
# to numbers
...
with open(input_file) as f:
    for line in f:
        ...
        for index in line_data_dictionary["symbol_indexes"]:
